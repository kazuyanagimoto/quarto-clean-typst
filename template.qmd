...
- However, the heading cross-refs is not supported, see [Appendix](#sec-appendix)
...
and be sourced from BibLaTeX, BibTeX, or CLS files. For example:
 ...
 - [Topic 1:]{.alert} Spatial Frictions [[@Fajgelbaum_Morales_Serrato_Zidar_2018; @Hsieh_Moretti_2019; @Moretti_2011]]{.small-cite}

- [Topic 2:]{.alert} @Suárez_Serrato_Zidar_2016
...
## Touying Heading Cross-refs {#sec-appendix}
